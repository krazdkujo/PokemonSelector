    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Pokedex...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
          {filteredPokedex.map((pokemon) => (
            <div
              key={pokemon.number}
              className={`
                bg-white rounded-lg p-3 text-center shadow-sm relative
        ...
        <div className="mt-8 bg-white rounded-lg p-4 shadow-sm">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">Caught</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-yellow-500 rounded-full"></div>
              <span className="text-sm text-gray-600">Seen (not caught)</span>
            </div>
            <div className="flex items-center gap-2">
